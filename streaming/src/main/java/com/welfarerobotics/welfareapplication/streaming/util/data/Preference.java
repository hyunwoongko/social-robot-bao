package com.welfarerobotics.welfareapplication.streaming.util.data;
...
public class Preference {
    ...
    public void setList(String paramString, List<String> paramList) {
        mSharedPreference.edit()
                .putString(paramString, new Gson().toJson(paramList))
                .apply();
    }

    public List<String> getList(String paramString) {
        return new Gson().fromJson(mSharedPreference.getString(paramString, ""),
