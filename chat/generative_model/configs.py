...
tf.app.flags.DEFINE_integer('train_steps', 3000, 'train steps')  # 학습 에포크
tf.app.flags.DEFINE_float('dropout_width', 0.5, 'dropout width')  # 드롭아웃 크기
tf.app.flags.DEFINE_integer('hidden_size', 256, 'weights size')  # 가중치 크기 # 논문 512 사용
tf.app.flags.DEFINE_float('learning_rate', 0.00015, 'learning rate')  # 학습률
...
tf.app.flags.DEFINE_integer('embedding_size', 256, 'embedding size')  # 임베딩 크기 # 논문 512 사용 학습 속도 및 성능 튜닝
tf.app.flags.DEFINE_integer('query_dimention', 256, 'query dimention')  # 논문 512 사용 학습 속도 및 성능 튜닝
tf.app.flags.DEFINE_integer('key_dimention', 256, 'key dimention')  # 논문 512 사용 학습 속도 및 성능 튜닝
tf.app.flags.DEFINE_integer('value_dimention', 256, 'value dimention')  # 논문 512 사용 학습 속도 및 성능 튜닝
tf.app.flags.DEFINE_integer('layers_size', 3, 'layers size')  # 논문은 6개
tf.app.flags.DEFINE_integer('heads_size', 4, 'heads size')  # 논문은 8개
