from entity_recognizer.wiki.kor_model.config import config
from entity_recognizer.wiki.kor_model.data_embed_model import word2vec, data_utils
from entity_recognizer.wiki.kor_model.data_embed_model.data_utils import CoNLLDataset
from entity_recognizer.wiki.kor_model.ner_model.lstmcrf_model import NERModel
...
def get_wiki_entity(sentence, is_train):
    if is_train:
        get_vocab()
