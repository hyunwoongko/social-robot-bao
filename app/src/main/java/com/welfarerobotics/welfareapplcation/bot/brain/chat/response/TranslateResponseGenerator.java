...
public class TranslateResponseGenerator {
    ...
    public static String response() throws IOException {
        ...
        if (lang.contains("일본") || lang.contains("일본어") || lang.contains("일본말")) {
            ...
            Mouth.get().setSpeaker("liangliang");
            ...
            Mouth.get().setSpeaker("jose");
            return PreprocessorApi.fix(TranslatorApi.translate("es", wordBuilder.toString()));
            ...
            return PreprocessorApi.fix("아직 한국어, 영어, 중국어, 일본어, 스페인어로 밖에 말하지 못해요.  " + langBuilder.toString() + "은 조금 더 공부 해볼게요.");
        }
    }
}