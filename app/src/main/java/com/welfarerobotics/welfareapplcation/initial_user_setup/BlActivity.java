...
import com.welfarerobotics.welfareapplcation.MainActivity;
...
public class BlActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.initial_bluetooth);
        //UI
        ...
        if (mBluetoothAdapter == null) {
            makeText(this, "블루투스를 지원하지 않는 단말기 입니다.", LENGTH_SHORT).show();
            finish();
            return;
        }
        //블루투스 브로드캐스트 리시버 등록
        ...
        if (ContextCompat.checkSelfPermission(BlActivity.this,
                Manifest.permission.ACCESS_COARSE_LOCATION)
                != PackageManager.PERMISSION_GRANTED) {
            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(BlActivity.this,
                    Manifest.permission.ACCESS_COARSE_LOCATION)) {
                ...
                ActivityCompat.requestPermissions(BlActivity.this,
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch(action){
                ...
                case BluetoothAdapter.ACTION_DISCOVERY_FINISHED:
                    Toast.makeText(BlActivity.this, "블루투스 검색 종료", Toast.LENGTH_SHORT).show();
                    mBluetoothAdapter.cancelDiscovery(); // 블루투스 검색 취소
                    txtState.setText("");
...
//                    chkFindme.setEnabled(true);
                    Toast.makeText(BlActivity.this, "검색응답 모드 종료", Toast.LENGTH_SHORT).show();
                    break;
                case BluetoothAdapter.SCAN_MODE_CONNECTABLE_DISCOVERABLE:
                    Toast.makeText(BlActivity.this, "다른 블루투스 기기에서 내 휴대폰을 찾을 수 있습니다.", Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    };
        ...
        switch (requestCode) {
            case BLUETOOTH_REQUEST_CODE:
                ...
                //블루투스 활성화 거절
                    ...
                    makeText(this, "블루투스를 활성화해야 합니다.", LENGTH_SHORT).show();
                    finish();
                    return;
                }
                break;
