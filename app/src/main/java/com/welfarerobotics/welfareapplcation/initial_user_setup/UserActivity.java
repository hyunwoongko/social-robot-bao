...
//        iv_UserPhoto = findViewById(R.id.imageView);
//        iv_UserPhoto.setOnClickListener(view -> {
//            int permissionCheck = ContextCompat.checkSelfPermission(UserActivity.this, Manifest.permission.CAMERA);
...
//        });
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.initial_user, container, false);
...
//        });
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_TAKE_PICTURE) {
            ...
            Toast.makeText(this.getApplicationContext(), "촬영 성공", Toast.LENGTH_SHORT).show();
            ...
            uploadTask.addOnFailureListener(exception -> {
                ...
                Toast.makeText(this.getApplicationContext(), taskSnapshot.getDownloadUrl().toString(), Toast.LENGTH_SHORT).show();
