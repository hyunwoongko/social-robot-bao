...
public final class CssApi {
    ...
    public CssApi play(String tts, String speaker) {
        try {
            ...
            con.setRequestProperty("X-NCP-APIGW-API-KEY-ID", ApiServer.clientId);
            con.setRequestProperty("X-NCP-APIGW-API-KEY", ApiServer.clientSecret);
            // post request
    ...
    public void stop(Runnable nextAction) {
        if (audioplay != null) {
            audioplay.setOnCompletionListener(mediaPlayer -> {
