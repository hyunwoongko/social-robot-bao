from entity_recognizer.exchange.kor_model.config import config
from entity_recognizer.exchange.kor_model.data_embed_model import word2vec, data_utils
from entity_recognizer.exchange.kor_model.data_embed_model.data_utils import CoNLLDataset
from entity_recognizer.exchange.kor_model.ner_model.lstmcrf_model import NERModel
...
def get_exchange_entity(sentence, is_train):
    if is_train:
        get_vocab()
