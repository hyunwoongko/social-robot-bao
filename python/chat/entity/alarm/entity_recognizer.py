...
from chat.entity.alarm.kor_model.config import config
...
from chat.entity.alarm.kor_model.ner_model.lstmcrf_model import NERModel
...
def get_vocab():
    ...
    vocab_words, vocab_tags = data_utils.get_vocabs(data_iter)
...
def get_alarm_entity(sentence, is_train):
    if is_train:
        get_vocab()
